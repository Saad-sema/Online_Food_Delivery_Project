...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  final _restNameC = TextEditingController();
  ...
  Future<void> _register() async {
    ...
    final data = {
      ...
      'role': 'restaurant',
      'restaurant_name': _restNameC.text.trim(),
    ...
    if (err != null) {
      ...
      Navigator.pop(context); // Go back to login or it will auto-redirect if listener is set up
    }
  }
      ...
      body: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: const [Color(0xFF059669), Color(0xFF10B981), Color(0xFFD1FAE5)],
          ),
        ),
        child: SafeArea(
          child: Center(
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    child: const Icon(Icons.storefront_rounded, size: 40, color: Color(0xFF059669)),
                  ),
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 12),
                          _buildField(_restNameC, 'Restaurant Name', Icons.restaurant_rounded),
                          const SizedBox(height: 12),
                          _buildField(_addressC, 'Full Address', Icons.location_on_outlined, maxLines: 2),
                          const SizedBox(height: 24),
                          SizedBox(
                            height: 52,
