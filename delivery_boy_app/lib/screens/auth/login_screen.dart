...
class _LoginScreenState extends State<LoginScreen> {
    ...
    return Scaffold(
      body: Container(
        decoration: BoxDecoration(
          gradient: const LinearGradient(begin: Alignment.topLeft, end: Alignment.bottomRight, colors: [Color(0xFF4F46E5), Color(0xFF818CF8), Color(0xFFEEF2FF)]),
        ),
        child: SafeArea(
          child: Center(
            child: SingleChildScrollView(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                Container(
                  ...
                  child: const Icon(Icons.delivery_dining_rounded, size: 56, color: Color(0xFF4F46E5)),
                ),
                const SizedBox(height: 20),
                const Text('FoodDash Delivery', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.white)),
                const SizedBox(height: 6),
                const Text('Deliver happiness, earn more', style: TextStyle(color: Colors.white70)),
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFF4F46E5), foregroundColor: Colors.white, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(14)), elevation: 0),
                          child: _loading
  ...
  InputDecoration _dec(String label, IconData icon) => InputDecoration(
    labelText: label, prefixIcon: Icon(icon, color: const Color(0xFF4F46E5)),
