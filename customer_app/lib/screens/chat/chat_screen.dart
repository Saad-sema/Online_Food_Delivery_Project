...
class ChatScreen extends StatefulWidget {
  ...
  const ChatScreen({super.key, required this.orderId, this.recipientName});
  @override
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(widget.recipientName != null ? 'Chat w/ ${widget.recipientName}' : 'Chat – Order #${widget.orderId}', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
  ...
  Widget _bubble(Map<String, dynamic> m) {
    ...
    final isMe = senderRole == 'customer';
